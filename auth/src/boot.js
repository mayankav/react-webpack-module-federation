...
function mount(el, { onNavigate, defaultHistory, initialPath, onUserSignIn }) {
    ...
    ReactDOM.render(<App history={history} onUserSignIn={onUserSignIn} />, el);
...
if(process.env.NODE_ENV === 'development') {
    const node = document.getElementById('auth-dev');
